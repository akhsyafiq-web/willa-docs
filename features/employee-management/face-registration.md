...
![Tahap Foto 2 dengan instruksi "Sedikit menoleh ke kanan"](./assets/02-foto2-menoleh-kanan.png)
...
![Tahap Foto 3 dengan instruksi "Sedikit menoleh ke kiri"](./assets/03-foto3-menoleh-kiri.png)
...
![Tahap Konfirmasi menampilkan 3 sampel foto wajah, dengan tombol Ulangi dan Simpan Data Wajah](./assets/04-konfirmasi-sampel-foto.png)
...
![Notifikasi berhasil setelah data wajah disimpan](./assets/05-notifikasi-berhasil.png)
...
![Kartu karyawan setelah registrasi wajah selesai, dengan foto profil yang baru](./assets/06-profil-setelah-registrasi.png)
